...
const HospitalProfile = () => {
    ...
    return (
        <div className="p-8 space-y-8 bg-gray-100 min-h-screen">
            {showEditProfileForm && <EditProfileForm closeProfileEditFormDialog={closeProfileEditFormDialog} details={profileData} setProfileData={setProfileData} />}
            <Sidebar openRequestFormDialog={() => { }} openProfileEditFormDialog={openProfileEditFormDialog} a={true} b={false} />
            {/* Profile Card */}
                    ...
                    <Typography>
                        ...
                        {profileData.verificationStatus === "Pending" && (
                            <>
                                ...
                                >
                                    <DialogTitle id="form-dialog-title">Add License Number</DialogTitle>
                                    <DialogContent>
                                        <TextField
                                            autoFocus
                                            margin="dense"
                                    ...
                                    <DialogActions>
                                        <Button onClick={() => setShowLicenseForm(false)} color="primary">
                                            Cancel
                                        </Button>
